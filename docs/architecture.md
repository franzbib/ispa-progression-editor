...
- `data/sample-progressions.ts` fournit les programmes A2-B1 et B1-B2 issus des exports fournis.
...
La persistance est faite dans `localStorage` avec restauration validee par Zod. Si la sauvegarde locale est invalide, elle est ignoree et un message visible est affiche.
